...
#
#   This version is updated to handle commas gracefully in the "Description="
#   portion of the --generatedby argument by explicitly parsing out Name, Version,
#   and Description.
#
# Usage:
...
#       --bids-version "1.10.0" \
#       --generatedby "Name=FSL,Version=6.0.7,Description=Used for motion correction, registration, and FEAT-based statistics." \
#       [--generatedby "Name=Other,Version=...,Description=..."] ...
#
# Notes:
...
#   Name=...,Version=...,Description=...
# The "Description" can contain commas; we capture everything after "Description="
###############################################################################
parse_generatedby() {
  local entry="$1"
