...
#
# Purpose:
#   Create (or overwrite) a TSV (tab-separated) file with user-specified columns and row data.
#
# Usage:
#   create_tsv.sh <TSV_PATH> <NUM_COLUMNS> <COLUMN1> [COLUMN2 ... COLUMNn] [ROW1] [ROW2] ...
#
# Usage Examples:
#   Example (1 column):
